---
title: Introduction to User-Agent detection
description: Why a User-Agent string alone misidentifies browsers, how hardware signals and Client Hints fix it, and how to choose the right ua-browser API.
---
