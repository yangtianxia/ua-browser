---
title: Browser Usage — detect browser, OS, and device
description: Detect browser, OS, and device type in the browser — when to use async uaBrowser.detect() for accuracy, and when the synchronous call is enough.
---
