...
**[📖 文档](https://ua-browser.yangtianxia.dev/zh/)** · **[🎮 Playground](https://ua-browser.yangtianxia.dev/zh/playground)** · **[English](./README.md)**
...
内置超过 70 种浏览器、20 种操作系统、40+ 种爬虫规则，详见 **[内置支持列表](https://ua-browser.yangtianxia.dev/zh/guide/support-list)**。
