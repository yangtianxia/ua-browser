...
export const BROWSER_DEFS: readonly BrowserDef[] = [
  ...
  { name: 'Zhihu',         priority: 605, detect: /(ZhihuHybrid|Zhihu\/[\d]|osee2unifiedReleaseVersion\/)/, versionPattern: [/Zhihu\/([\d.]+)/, /osee2unifiedReleaseVersion\/([\d.]+)/] },
  ...
  { name: 'Ctrip',         priority: 610, detect: /Ctrip\/[\d]/,          versionPattern: /Ctrip\/([\d.]+)/ },
  { name: 'WeRead',        priority: 611, detect: /(WeRead|wxread)\/[\d]/, versionPattern: [/WeRead\/([\d.]+)/, /wxread\/([\d.]+)/] },
